module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('tests', [
      ...
      { module_id: 21, test_type: 'pretest', created_at: new Date(), updated_at: new Date() },
      { module_id: 23, test_type: 'minitest', created_at: new Date(), updated_at: new Date() },
      { module_id: 24, test_type: 'posttest', created_at: new Date(), updated_at: new Date() },
    ], {});
  },
